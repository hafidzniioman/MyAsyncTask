package com.example.cetak1.myasynctask;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        demoAsync.execute("ini Demo Async");
    ...
    private class DemoAsync extends AsyncTask<String, Void , String>{
        ...
        @Override
            ...
            Log.d(DEMO_ASYNC, "status : do in Background");
            try {
                Thread.sleep(5000);
            }catch (Exception e){
        ...
        @Override
            ...
            tvStatus.setText("status : on Post Execute : "+s);
        }
    }
}
